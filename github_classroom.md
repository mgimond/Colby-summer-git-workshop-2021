...
The first step is to setup the GitHub accounts for your course. 



## Initial setup

### Creating a new organization for your classroom

In this exercise, you will create a new organization account for her classroom.  In the steps that follow, we'll assume that the user `jdcolby2` is the instructor.
...
* If you are prompted to pick an plan for your organization, pick the **Free** option.
* In the *Set up your organization* page, create you organization name. Adopt a naming convention that wil be systematic. For example, we'll name this account `colby-git123-fa2021`.
* Add your contact email and the account (yours) associated with this organization. You may also be prompted to verify that you are not a *robot* by solving a puzzle at the bottom of the page.
  <img src="img_classroom/image-20210531090356404.png" alt="image-20210531090356404" style="max-width:40%;border: 2px solid #ccc;" />
* Click **Next**.
...
* In the next page, you may be asked to complete a survey before proceeding. You might alse be asked if you have an **existing repository for this project**. Select **No** for now. Click **Submit** to continue.
* The next page will be your course repository landing page.  This will be where you will create assignment repo templates for this course.
  <img src="img_classroom/image-20210531091123313.png" alt="image-20210531091123313" style="max-width:40%;border: 2px solid #ccc;" />
...
* Send the students an Invite via the **Invite someone** link. When prompted for a role, you'll probably want to assign them as **Members**. 
  <img src="img_classroom/image-20210531091834708.png" alt="image-20210531091834708" style="max-width:40%;border: 2px solid #ccc;" />
  
* Once the invite is sent, students will need to check their email inbox for the invitation.
...
* On the next page, you will be asked to select the course organizational account you will be working with.
  <img src="img_classroom/image-20210531095104924.png" alt="image-20210531095104924" style="max-width:40%;border: 2px solid #ccc;" />
* On the next page, give your classroom a name (this can be the same as the organizational account).
  <img src="img_classroom/image-20210531095234653.png" alt="image-20210531095234653" style="max-width:50%;border: 2px solid #ccc;" />
* On the next page, you can invite TAs our other instructors that may need admin access to this classroom.  Click **Continue** when done.
...
At this point, you will see your GitHub classroom landing page. This is a one time operation. You will want to note and bookmark:
...
* Your **GitHub Classroom** page ([GitHub Classroom](https://classroom.github.com/classrooms)).
...
### Create an assignment repo template
...
* Give this repo a name, e.g. `HW01`. You'll probably want to keep this repo private (i.e. only accessible to your classroom organization). You'll also want to create a README file that will provide students with assignment instructions.
  <img src="img_classroom/image-20210531092851838.png" alt="image-20210531092851838" style="max-width:50%;border: 2px solid #ccc;" />
...
* Once you've created your assignment repo, you will need to convert it to a template. Doing so will allow students to clone this assignment in their own GitHub account.
  ...
  <img src="img_classroom/image-20210531093648124.png" alt="image-20210531093648124" style="max-width:50%;border: 2px solid #ccc;" />

  

### Share the assignment repo via Classroom
...
* Assign a name to this assignment. It can be the same  name as that created in the Organization account. You can stick with the other defaults if this is an individual assignment. Click **Continue**.
  <img src="img_classroom/image-20210531101340682.png" alt="image-20210531101340682" style="max-width:40%;border: 2px solid #ccc;" />
* Next, assign a repo template to this Classroom assignment. Do so by clicking on the **Select a repository** pull-down menu and start typing the first few letters of your Organization repo name (in tjis example, we start typing `colby-` at which point our `colby-git-fa2021/HW01` should pop up. It may take a few seconds before GitHub list of repo names starting with `colby-`.
  <img src="img_classroom/image-20210531101723965.png" alt="image-20210531101723965" style="max-width:60%;border: 2px solid #ccc;" />
* Click **Continue**.
* We will not add autograding features, so we can click on the **Create assignment** button.

The Classroom assignment is ready. Note the link to this assignment. 
  <img src="img_classroom/image-20210531102135095.png" alt="image-20210531102135095" style="max-width:50%;border: 2px solid #ccc;" />
...
2. Clone the repo  template to your GitHub account by typing or copying/pasting the GitHub Classroom link [*this is the sample link created in the last step*]:
   https://classroom.github.com/a/jWPc0wCj
...
4. You may need to wait a few seconds before the repo is copied to your personal account. You might have to refresh the page to see the link to your repo. In the following example, the repo was cloned by `jdcolby` hence the repo name `hw01-jdcolby`. Your repo should reflect your account name.
   <img src="img_classroom/image-20210531103717754.png" alt="image-20210531103717754" style="max-width:40%;border: 2px solid #ccc;" />
...
* In this example, we'll name it `grp_hw02` and change the settings to **Group assignment**. If you plan to recycle the set f teams for future assignments, you might want to assign a meaningful name to this set of teams. You can also define the maximum number of teams and team members.
  <img src="img_classroom//image-20210531123942130.png" alt=" " style="border: 2px solid #ccc;" /> 

* On the next page, you will be prompted to select the **template repository** was was done in an earlier exercise. From there, adopt the default settings.  This will generate a new link for this group assignment that you will share with your students.
...
* Navigate to the GitHub classroom provided link
  ...
  * If the student's assigned team has  been created, she simply needs to click on the team name **Join** buttom.
